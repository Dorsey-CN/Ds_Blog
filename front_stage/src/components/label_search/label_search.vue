    ...
    <div class="label-list">
        <div class="content-path">
            <ol class="breadcrumb sider-margin">
                <li class="active">具有<span class="label-name">{{labelName}}</span>标签的所有文章</li>
            </ol>
        </div>
            ...
            <div class="row">
                ...
                <div class="tags col-md-12 col-lg-12">
                    ...
                    <span class="labels tag-item">
                        ...
                        <a href="#">
                            <i v-text="labelName" class="tag-text"></i>
                        </a>
                    </span>
                </div>
       ...
       <div class="pagination-wrapper" v-show="searchResult.length>0">
           <ul class="pagination">
...
export default {
	...
	methods: {
        getByLabel(pageCount) {
            let label = window.location.hash.split('label=')[1].split('&')[0];
            this.labelName = decodeURIComponent(window.location.hash.split('labelname=')[1]);
            let url = '/article/label?label=' + label;
            if(pageCount) {
                url += '&p=' + pageCount;
            }
